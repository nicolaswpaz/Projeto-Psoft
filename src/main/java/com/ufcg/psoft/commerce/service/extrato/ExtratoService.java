...
public class ExtratoService {
    ...
    @Autowired
    public ExtratoService(ClienteRepository clienteRepository, OperacaoRepository operacaoRepository) {
    ...
    public void gerarExtratoCSV(Long clienteId, String codigoAcesso, OutputStream outputStream) throws IOException {
        ...
        try (Writer writer = new OutputStreamWriter(outputStream, StandardCharsets.UTF_8)) {
            ...
            List<Operacao> operacoes = operacaoRepository.findByContaIdOrderByDataSolicitacaoAsc(conta.getId());
